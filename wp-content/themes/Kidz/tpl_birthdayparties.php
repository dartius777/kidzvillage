...
<div class="section_wrapper">
                ...
                <section class="main_content">
                    <div class="left_content_wrapper">
                        ...
                        <img class="main_banner" src="<?php echo get_template_directory_uri(); ?>/img/img021.jpg" alt=""/>
                        <section class="main_content">
                    ...
                    <div class="right_content_wrapper">
                        ...
                        <ul class="visit_us_category">
                            <li><a href="<?php echo get_template_directory_uri(); ?>/pdf/Party_Menu.pdf">Party Menu (<img src="<?php echo get_template_directory_uri(); ?>/img/pdf.png" alt="" />)</a></li>
                            <li><a href="<?php echo get_permalink(134); ?>">Party Upgrades</a></li>
                        </ul>
